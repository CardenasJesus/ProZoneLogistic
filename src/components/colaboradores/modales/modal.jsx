              ...
              <nav className='w-full p-4 grid grid-cols-1 h-fit'>
                <div className='w-full flex justify-between items-baseline'>
                  ...
                  <button onClick={handleClose}>
                    <svg className="w-4 h-4 bg-transparent text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <div className='w-full flex justify-center items-center content-center'>
                  <form onSubmit={handleSubmit} className="w-full p-4">
                    ...
                    <div className='mb-6'>
                        ...
                        <div className=''>
                                        <label htmlFor="rol" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Asigne un Rol</label>
                                        <select id="rol" name='rol' onChange={handleInputChange} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div className=''>
                        <label htmlFor="countries" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Asigne un status</label>
            ...
            >
                ...
                <Box sx={style}>
                    ...
                    <nav className='w-full p-4 grid grid-cols-1'>
                        ...
                        <h1 className='font-bold text-2xl text-center'>Crear Cuenta de colaboradro</h1>
                        ...
                        <form onSubmit={handleSubmit} className="w-full p-4">
                            ...
                            <div>
                            <label htmlFor="eat_password" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Confirme Password</label>
                            <input
                                type="password"
                        ...
                        <div className=''>
                        <label htmlFor="select_status" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Confirme Password</label>
                            ...
                            <div className='grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-4 mb-4'>
                                <div className=''>
                                        <label htmlFor="id_rol" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Asigne un Rol</label>
                                        <select id="id_rol" name='rol' onChange={handleInputChange} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    ...
                                    <div className=''>
                                        <label htmlFor="id_departamento" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Asigne un Departamento</label>
                                        <select id="id_departamento" name='departamento' onChange={handleInputChange} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
