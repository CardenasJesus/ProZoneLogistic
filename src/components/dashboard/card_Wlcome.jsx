const CardWelcome = () =>{
    return(
        <>
        <div className="grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 justify-center items-center content-center ml-24"> 
                <div className='bg-green-300 rounded-xl grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 text-center conten-center text-center'>
                    <nav className="p-8">
