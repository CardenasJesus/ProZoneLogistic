...
const Main = () =>{
    ...
    return(
        <>
        <div className="bg-gray-100 p-4 rounded-2xl shadow-xl mt-12"><h1 className="font-bold text-2xl sm:text-4xl p-2 tracking-tighter text-gray-900">Finalizados ({Envios.length})</h1></div>
       <section>
